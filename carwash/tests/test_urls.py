...
from carwash.views import marca_lista, marca_eliminar, marca_nueva, marca_editar, cliente_lista, cliente_nuevo, cliente_editar, cliente_eliminar, lista_servicio, servicio_nuevo, servicio_editar, servicio_eliminar, automovil_editar, automovil_eliminar, automovil_lista, automovil_nuevo
